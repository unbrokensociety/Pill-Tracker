...
object ReportExportHelper {
    ...
    fun generateAndShareReport(
        ...
        builder.append("\n=========================================\n")
        builder.append("Generated by MediTracker App\n")

        val reportText = builder.toString()

        try {
            val reportFile = File(context.cacheDir, "MediTracker_Report_$dateStr.txt")
            ...
            val sendIntent = Intent().apply {
                ...
                putExtra(Intent.EXTRA_SUBJECT, "MediTracker Medical Report - ${userAccountName.ifBlank { "Patient" }} ($dateStr)")
