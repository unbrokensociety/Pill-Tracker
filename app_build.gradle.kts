...
android {
  ...
  defaultConfig {
    ...
    //   • every GitHub CI build:   versionCode = 2000 + run_number (2001, 2002, …)
    //   • the ready-made APK from the delivery site: versionCode = 2000
    //   • all older CI builds:     1000 + run_number (< 2000)
